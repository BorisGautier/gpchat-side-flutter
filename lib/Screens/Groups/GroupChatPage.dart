...
import 'package:gpchat/Screens/Groups/GroupDetails.dart';
...
//       //----sharing intent action:
  ...
  //                       focusNode: keyboardFocusNode,
  //                       maxLines: null,
  //                       style: TextStyle(fontSize: 16.0, color: gpchatBlack),
  //                       controller: textEditingController,
  //                       decoration: InputDecoration(
  //                         enabledBorder: OutlineInputBorder(
  //                           // width: 0.0 produces a thin "hairline" border
  ...
  //                             maxLines: null,
  //                             style: TextStyle(
  //                                 fontSize: 18.0, color: gpchatBlack),
  //                             controller: textEditingController,
  //                             decoration: InputDecoration(
  //                               enabledBorder: OutlineInputBorder(
  //                                 // width: 0.0 produces a thin "hairline" border
                  ...
                  : GroupChatBubble(
                      ...
                      child: doc[Dbkeys.groupmsgISDELETED] == true
                          ? Text(
                              ...
                              style: TextStyle(
                                  color: gpchatBlack.withOpacity(0.6),
                                  fontSize: 15,
