...
import 'package:gpchat/widgets/Common/cached_image.dart';
        ...
        children: [
          ...
          status == 'pickedup'
              ...
              : Container(
                  ...
                  child: Icon(
                    ...
                    size: w > h ? 60 : 140,
                    color: DESIGN_TYPE == Themetype.whatsapp
                        ? gpchatWhite.withOpacity(0.25)
                        : gpchatBlack.withOpacity(0.25),
                  ),
                ),
          SizedBox(height: 45),
          Text(
          ...
          Text(
            ...
            style: TextStyle(
              fontWeight: FontWeight.bold,
              color: DESIGN_TYPE == Themetype.whatsapp
                  ? gpchatWhite.withOpacity(0.54)
                  : gpchatBlack.withOpacity(0.54),
              fontSize: 19,
            ),
          ),
          SizedBox(
