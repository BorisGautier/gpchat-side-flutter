...
class _LazyLoadingChatState extends State<LazyLoadingChat>
  ...
  void initState() {
    ...
    chatId = GPChat.getChatId(widget.currentUserNo, widget.peerNo);
...
//       //----sharing intent action:
  ...
  dynamic encryptWithCRC(String input) {
    try {
      ...
      GPChat.toast('Error occured while encrypting !');
      return false;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final observer = Provider.of<Observer>(context, listen: true);
    return PickupLayout(
        scaffold: GPChat.getNTPWrappedWidget(Consumer<List<GroupModel>>(
