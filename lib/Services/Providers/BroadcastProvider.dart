...
import 'package:gpchat/Services/Providers/FirebaseAPIProvider.dart';
        ...
        await FirebaseFirestore.instance
          ...
          try {
            ...
            if (encrypted is String) {
              ...
              if (content.trim() != '') {
                var chatId = GPChat.getChatId(currentUserNo, peer);
                await FirebaseFirestore.instance
                    .collection(DbPaths.collectionbroadcasts)
                    .doc(broadcastId)
                    .collection(DbPaths.collectionbroadcastsChats)
            ...
            GPChat.toast('Failed to Send message. Error:$e');
          }
        }).catchError(((e) {
          GPChat.toast('Failed to Send message. Error:$e');
        }));
